...
#include <AIDB/Common/VectorDataset.h>
#include <AIDB/Common/SegmentsMgr.h>
#include <AIDB/Common/Segment.h>

#include <AIDB/Common/VectorIndexObject.h>
...
public:
    ...
    {
        String part_name_no_mutation = AIDB::cutMutVer(part_name);
    ...
    bool needClearVectorIndexCache(
        ...
        const AIDB::CachedSegmentKey & cache_key,
    ...
    static void abortLoadVectorIndex(std::vector<AIDB::CachedSegmentKey> & loaded_keys);
    ...
    AIDB::SegmentBuiltStatus buildVI(const VIContextPtr ctx);
    ...
    AIDB::SegmentBuiltStatus TryMoveVIFiles(const VIContextPtr ctx);
...
protected:
    ...
    AIDB::SegmentBuiltStatus buildVIForOnePart(VIContextPtr ctx);
    ...
    void moveVIFilesToFuturePartAndCache(
        ...
        DiskPtr disk,
        AIDB::CachedSegmentPtr build_index,
