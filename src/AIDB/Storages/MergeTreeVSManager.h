...
private:
    ...
    static AIDB::VectorDatasetPtr<T> generateVectorDataset(bool is_batch, const VSDescription & desc);

    template <>
    AIDB::VectorDatasetPtr<Search::DataType::FloatVector> generateVectorDataset(bool is_batch, const VSDescription & desc);

    template <>
    AIDB::VectorDatasetPtr<Search::DataType::BinaryVector> generateVectorDataset(bool is_batch, const VSDescription & desc);
