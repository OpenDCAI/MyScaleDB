...
struct VSDescription
{
    ...
    String search_index_name;       /// index name used for vector scan (support multiple indexes on a vector column)
...
struct SparseSearchInfo
{
    ...
    static SearchMode strToSparseMode(const String & mode)
    {
