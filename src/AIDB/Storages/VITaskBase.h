...
protected:
    ...
    virtual AIDB::SegmentBuiltStatus prepare() { return AIDB::SegmentBuiltStatus{AIDB::SegmentBuiltStatus::SUCCESS}; }
    ...
    AIDB::SegmentBuiltStatus build_status{AIDB::SegmentBuiltStatus::SUCCESS};
