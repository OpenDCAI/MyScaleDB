...
#define APPLY_FOR_PARSER_KEYWORDS(MR_MACROS) \
    ...
    MR_MACROS(VECTOR, "VECTOR") \
    MR_MACROS(VECTOR_INDEX, "VECTOR INDEX") \
    MR_MACROS(ADD_VECTOR_INDEX, "ADD VECTOR INDEX") \
    MR_MACROS(DROP_VECTOR_INDEX, "DROP VECTOR INDEX") \
    MR_MACROS(LIGHTWEIGHT_DELETE, "LIGHTWEIGHT DELETE") \
