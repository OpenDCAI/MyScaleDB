...
#define APPLY_FOR_BUILTIN_ERROR_CODES(M) \
    ...
    M(733, INVALID_VECTOR_INDEX) \
    M(734, VECTOR_INDEX_BUILD_MEMORY_TOO_LARGE) \
    M(735, VECTOR_INDEX_BUILD_MEMORY_INSUFFICIENT) \
    M(736, VECTOR_INDEX_ALREADY_EXISTS) \
    M(737, TANTIVY_INDEX_STORE_INTERNAL_ERROR) \
    M(738, TANTIVY_BUILD_INDEX_INTERNAL_ERROR) \
    M(739, TANTIVY_SEARCH_INTERNAL_ERROR) \
    M(740, TANTIVY_INDEX_FILES_SERIALIZE_ERROR) \
    M(741, TANTIVY_INDEX_FILES_DESERIALIZE_ERROR) \
    M(742, ILLEGAL_TEXT_SEARCH) \
    M(743, ILLEGAL_HYBRID_SEARCH) \
    M(744, TANTIVY_INDEX_FILE_MANAGEMENT_ERROR) \
    M(745, TANTIVY_INDEX_CACHE_RELOAD_ERROR) \
    M(746, VECTOR_INDEX_CACHE_LOAD_ERROR) \
    M(747, SPARSE_SEARCH_INTERNAL_ERROR) \
    M(748, ILLEGAL_SPARSE_SEARCH) \
    M(749, CUSTOM_SKIP_INDEX_FILES_MANAGER_ERROR) \
    M(750, CUSTOM_SKIP_INDEX_FILES_ARCHIVE_ERROR) \
    M(751, CUSTOM_SKIP_INDEX_FILES_EXTRACT_ERROR) \
    M(752, CUSTOM_SKIP_INDEX_BUILD_INTERNAL_ERROR) \
    M(753, CUSTOM_SKIP_INDEX_SEARCH_INTERNAL_ERROR) \
    M(754, SERVER_OVERLOADED) \
    \
