...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    \
    M(ALTER_ADD_VECTOR_INDEX, "ADD VECTOR INDEX", TABLE, ALTER_INDEX) \
    M(ALTER_DROP_VECTOR_INDEX, "DROP VECTOR INDEX", TABLE, ALTER_INDEX) \
    ...
    M(SHOW_CONNECTIONS, "SHOW CREATE CONNECTION", GLOBAL, SHOW_ACCESS) \
    ...
    M(SYSTEM_BUILD_VECTOR_INDICES, "SYSTEM STOP BUILD VECTOR INDICES, SYSTEM START BUILD VECTOR INDICES, STOP BUILD VECTOR INDICES, START BUILD VECTOR INDICES", TABLE, SYSTEM) \
    ...
    M(SYSTEM_WAIT_BUILDING_VECTOR_INDICES, "WAIT BUILDING VECTOR INDICES", TABLE, SYSTEM) \
