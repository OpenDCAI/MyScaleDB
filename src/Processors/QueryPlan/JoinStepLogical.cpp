...
{
    updateInputStreams(DataStreams{DataStream{left_header_}, DataStream{right_header_}});
}
...
void JoinStepLogical::updateOutputStream()
{
    DataStream & stream = output_stream.emplace();
