    ...
    IQueryTreeNode::HashState hash_table_key_hash)
{
    ...
    {
        auto join = tryCreateJoin(algorithm, table_join, right_table_expression, left_table_expression_header, right_table_expression_header, query_context, hash_table_key_hash);
        if (join)
            return join;
    }
